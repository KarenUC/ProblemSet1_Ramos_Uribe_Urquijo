...
# Se escoge la variable ingresos totales despuÃ©s de revisar la base, dado que 
...
### QuÃ© tan bueno el el fit del moelo?
#El fit es malo segÃºn Rcuadrado - Revisar argumento
#Plot the predicted age-earnings profile implied by the above equation.
Base_var$prediccion1<-predict(model_income)

########
#CorrelaciÃ³n entre predicciÃ³n y valor observado
